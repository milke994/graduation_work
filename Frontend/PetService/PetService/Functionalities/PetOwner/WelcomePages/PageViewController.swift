...
//        }
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.newViewController(viewControllerIdentifier: "WelcomePageOne"),
                self.newViewController(viewControllerIdentifier: "WelcomePageTwo"),
                self.newViewController(viewControllerIdentifier: "WelcomePageThree")];
    }();
